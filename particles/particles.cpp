...
static const char *s_RemapOperatorNameTable[]={
	...
	// CSSO 2.0 particle function remaps
	"Velocity Set from Control Point", "Movement Basic",
	"Alpha Fade Out Simple", "Alpha Fade Out Random",
	"Alpha Fade In Simple", "Alpha Fade In Random",
	"Cull when crossing sphere", "Cull when crossing plane",
	"Cull relative to Ray Trace Environment", "Cull relative to model",
	"time varying force", "random force",
	"turbulent force", "random force",
	"Position Along Ring", "Position Within Sphere Random",
	"Position Modify Place On Ground", "Movement Basic",
	"Movement Place On Ground", "Movement Basic",
	"Scalar Random", "Remap Noise to Scalar",
	"Render models", "render_animated_sprites",
	"Clamp Scalar", "Remap Scalar",
	"Alpha Fade and Decay for Tracers", "Alpha Fade and Decay",
	"Set Control Point to Impact Point", "Set Control Point To Particles' Center",
	"Color Lit Per Particle", "Color Random",
	"Force based on distance from plane", "Pull towards control point",
	"Remap Speed to Scalar", "Remap Scalar",
};
